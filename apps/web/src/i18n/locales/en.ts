const en = {
  ...
  "title.scheduledTasks": "Scheduled tasks · 灵光",
  ...
  "mcp.subtitle": "Connect Model Context Protocol servers so your agent can use their tools.",
  "mcp.add": "Add server",
  "mcp.empty": "No MCP servers yet. Add one to give your agent extra tools.",
  "mcp.name": "Name",
  "mcp.namePlaceholder": "e.g. filesystem, github",
  "mcp.transport": "Connection type",
  "mcp.transportHttp": "Remote (HTTP)",
  "mcp.transportStdio": "Local command",
  "mcp.url": "Server URL",
  "mcp.token": "Access token (optional)",
  "mcp.tokenPlaceholder": "Bearer token, if the server needs one",
  "mcp.command": "Command",
  "mcp.args": "Arguments",
  "mcp.cancel": "Cancel",
  "mcp.save": "Save",
  "mcp.delete": "Remove",
  "mcp.addSuccess": "MCP server added",
  "mcp.deleteSuccess": "MCP server removed",
  "mcp.nameRequired": "Please enter a name",
  "mcp.urlRequired": "Please enter the server URL",
  "mcp.commandRequired": "Please enter the command",

  // ── Scheduled tasks ──
  "scheduledTasks.title": "Scheduled tasks",
  "scheduledTasks.subtitle":
    "Have your assistant run a task automatically on a schedule, and optionally notify an IM channel with the result.",
  "scheduledTasks.newTask": "New task",
  "scheduledTasks.create": "Create",
  "scheduledTasks.cancel": "Cancel",
  "scheduledTasks.created": "Scheduled task created",
  "scheduledTasks.deleted": "Scheduled task deleted",
  "scheduledTasks.runTriggered": "Task run started",
  "scheduledTasks.validation": "Please enter a name and instruction",
  "scheduledTasks.emptyTitle": "No scheduled tasks yet",
  "scheduledTasks.emptyDesc":
    "Create a task to have your assistant run something on a recurring schedule.",
  "scheduledTasks.nextRun": "Next",
  "scheduledTasks.lastRun": "Last",
  "scheduledTasks.notifiesChannel": "Notifies an IM channel on completion",
  "scheduledTasks.runNow": "Run now",
  "scheduledTasks.delete": "Delete",
  "scheduledTasks.confirmDelete": "Delete this scheduled task?",
  "scheduledTasks.status.success": "Success",
  "scheduledTasks.status.error": "Failed",
  "scheduledTasks.status.running": "Running",
  "scheduledTasks.frequency.minutely": "Every minute",
  "scheduledTasks.frequency.hourly": "Hourly",
  "scheduledTasks.frequency.daily": "Daily",
  "scheduledTasks.frequency.weekly": "Weekly",
  "scheduledTasks.frequency.monthly": "Monthly",
  "scheduledTasks.desc.minutely": "Every minute",
  "scheduledTasks.desc.hourly": "Every hour at :{{minute}}",
  "scheduledTasks.desc.daily": "Every day at {{time}}",
  "scheduledTasks.desc.weekly": "Every {{day}} at {{time}}",
  "scheduledTasks.desc.monthly": "Day {{day}} of each month at {{time}}",
  "scheduledTasks.weekday.0": "Sunday",
  "scheduledTasks.weekday.1": "Monday",
  "scheduledTasks.weekday.2": "Tuesday",
  "scheduledTasks.weekday.3": "Wednesday",
  "scheduledTasks.weekday.4": "Thursday",
  "scheduledTasks.weekday.5": "Friday",
  "scheduledTasks.weekday.6": "Saturday",
  "scheduledTasks.field.name": "Task name",
  "scheduledTasks.field.namePlaceholder": "e.g. Morning summary",
  "scheduledTasks.field.instruction": "Instruction",
  "scheduledTasks.field.instructionPlaceholder":
    "What should the assistant do each time this runs?",
  "scheduledTasks.field.frequency": "Frequency",
  "scheduledTasks.field.hour": "Hour (0-23)",
  "scheduledTasks.field.minute": "Minute (0-59)",
  "scheduledTasks.field.dayOfWeek": "Day of week",
  "scheduledTasks.field.dayOfMonth": "Day of month",
  "scheduledTasks.field.agent": "Agent",
  "scheduledTasks.field.defaultAgent": "Default agent",
  "scheduledTasks.field.notifyChannel": "Notify channel (optional)",
  "scheduledTasks.field.noNotify": "Don't notify",
  "scheduledTasks.field.notifyTarget": "Recipient",
  "scheduledTasks.field.notifyTargetPlaceholder": "Chat / user id",
  "scheduledTasks.field.notifyTargetHint":
    "The chat or user id on that channel to send the result to.",
  ...
  "desktopChat.subagents": "Subagents ({{count}})",
  "desktopChat.subagentStatus.started": "Working",
  "desktopChat.subagentStatus.completed": "Delivered",
  "desktopChat.subagentStatus.failed": "Failed",
