const zhCN = {
  ...
  "title.claim": "认领 · 灵光",
  "title.home": "首页 · 灵光",
  "title.desktopChat": "新建任务 · 灵光",
  "title.channels": "连接 · 灵光",
  "title.scheduledTasks": "定时任务 · 灵光",
  "title.integrations": "集成 · 灵光",
  "title.rewards": "奖励 · 灵光",
  "title.skills": "技能 · 灵光",
  "title.settings": "设置 · 灵光",
  "title.linkFeishu": "绑定飞书 · 灵光",
  "title.connecting": "连接中 · 灵光",
  ...
  "layout.nav.home": "首页",
  "layout.nav.chat": "对话",
  "layout.nav.newTask": "新建任务",
  "layout.nav.channels": "连接",
  "layout.nav.scheduledTasks": "定时任务",
  "layout.nav.integrations": "集成",
  ...
  "settings.desktop.launchAtLoginHint": "当您的电脑开机启动时自动打开灵光",
  "settings.desktop.showInDock": "在 Dock 中显示应用",
  "settings.desktop.showInDockHint":
    "在您的 Mac Dock 中显示灵光，以便快速访问。",
  ...
  "settings.providers.botModelTitle": "灵光 Bot 模型",
  ...
  "skills.importSkillDesc": "从 zip 文件或本地文件夹添加自定义技能",
  "skills.uploadZip": "上传 Zip",
  "skills.localFolder": "本地文件夹",
  "skills.browseFolder": "选择技能文件夹",
  "skills.noFolderSelected": "未选择文件夹",
  "skills.folderHint":
    "选择一个包含 SKILL.md 的文件夹（或其中仅含一个技能的父文件夹），将直接复制安装，无需联网。",
  ...
  // ── MCP 服务器 ──
  "mcp.title": "MCP 服务器",
  "mcp.subtitle": "连接 MCP（模型上下文协议）服务器，让你的 Agent 能调用它们提供的工具。",
  "mcp.add": "添加服务器",
  "mcp.empty": "还没有 MCP 服务器。添加一个来给 Agent 扩展工具能力。",
  "mcp.name": "名称",
  "mcp.namePlaceholder": "例如 filesystem、github",
  "mcp.transport": "连接方式",
  "mcp.transportHttp": "远程（HTTP）",
  "mcp.transportStdio": "本地命令",
  "mcp.url": "服务器地址",
  "mcp.token": "访问令牌（可选）",
  "mcp.tokenPlaceholder": "如果服务器需要，填写 Bearer 令牌",
  "mcp.command": "命令",
  "mcp.args": "参数",
  "mcp.cancel": "取消",
  "mcp.save": "保存",
  "mcp.delete": "删除",
  "mcp.addSuccess": "已添加 MCP 服务器",
  "mcp.deleteSuccess": "已删除 MCP 服务器",
  "mcp.nameRequired": "请输入名称",
  "mcp.urlRequired": "请输入服务器地址",
  "mcp.commandRequired": "请输入命令",

  // ── 定时任务 ──
  "scheduledTasks.title": "定时任务",
  "scheduledTasks.subtitle":
    "让助手按计划自动执行任务，并可选择在完成后向 IM 渠道发送结果消息。",
  "scheduledTasks.newTask": "新建任务",
  "scheduledTasks.create": "创建",
  "scheduledTasks.cancel": "取消",
  "scheduledTasks.created": "定时任务已创建",
  "scheduledTasks.deleted": "定时任务已删除",
  "scheduledTasks.runTriggered": "任务已开始执行",
  "scheduledTasks.validation": "请填写任务名称和指令",
  "scheduledTasks.emptyTitle": "还没有定时任务",
  "scheduledTasks.emptyDesc": "创建一个任务，让助手按周期自动执行。",
  "scheduledTasks.nextRun": "下次",
  "scheduledTasks.lastRun": "上次",
  "scheduledTasks.notifiesChannel": "完成后会通知 IM 渠道",
  "scheduledTasks.runNow": "立即执行",
  "scheduledTasks.delete": "删除",
  "scheduledTasks.confirmDelete": "确定删除此定时任务？",
  "scheduledTasks.status.success": "成功",
  "scheduledTasks.status.error": "失败",
  "scheduledTasks.status.running": "执行中",
  "scheduledTasks.frequency.minutely": "每分钟",
  "scheduledTasks.frequency.hourly": "每小时",
  "scheduledTasks.frequency.daily": "每天",
  "scheduledTasks.frequency.weekly": "每周",
  "scheduledTasks.frequency.monthly": "每月",
  "scheduledTasks.desc.minutely": "每分钟执行",
  "scheduledTasks.desc.hourly": "每小时的第 {{minute}} 分执行",
  "scheduledTasks.desc.daily": "每天 {{time}} 执行",
  "scheduledTasks.desc.weekly": "每{{day}} {{time}} 执行",
  "scheduledTasks.desc.monthly": "每月 {{day}} 日 {{time}} 执行",
  ...
  "scheduledTasks.field.namePlaceholder": "例如：早晨摘要",
  "scheduledTasks.field.instruction": "指令",
  "scheduledTasks.field.instructionPlaceholder": "每次执行时助手应该做什么？",
  "scheduledTasks.field.frequency": "频率",
  "scheduledTasks.field.hour": "小时 (0-23)",
  "scheduledTasks.field.minute": "分钟 (0-59)",
  "scheduledTasks.field.dayOfWeek": "星期几",
  "scheduledTasks.field.dayOfMonth": "每月几号",
  "scheduledTasks.field.agent": "Agent",
  "scheduledTasks.field.defaultAgent": "默认 Agent",
  "scheduledTasks.field.notifyChannel": "通知渠道（可选）",
  "scheduledTasks.field.noNotify": "不通知",
  "scheduledTasks.field.notifyTarget": "接收方",
  "scheduledTasks.field.notifyTargetPlaceholder": "会话 / 用户 ID",
  "scheduledTasks.field.notifyTargetHint": "结果将发送到该渠道上的此会话或用户 ID。",
  ...
  "desktopChat.subagents": "子智能体（{{count}}）",
  "desktopChat.subagentStatus.started": "执行中",
  "desktopChat.subagentStatus.completed": "已交付",
  "desktopChat.subagentStatus.failed": "失败",
